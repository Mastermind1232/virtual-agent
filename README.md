...
Current packaging: Virtual Agent 1.8.4 (released by inGramGames on 2026-07-16), packaged as 1.8.4.10. Social and Style say "in AGZ". The GM's home screen ticks the apps at least one player can see. For this campaign the NCPD DB app is labelled AGPD DB and the Fixers app is labelled Contacts, and NC Mart is labelled NuNu Mart.
